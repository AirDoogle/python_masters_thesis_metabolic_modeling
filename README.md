...
Repository for Python and R scripts, along with results from my MSc thesis in Bioinformatics & Computational Biology (University College Cork, 2024). Featuring statistical analysis,  principal component analysis (PCA), metabolic modeling, k-means clustering, significance & multiple testing and reaction pathway analysis. 
